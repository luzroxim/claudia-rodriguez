...
En este módulo debemos diseñar un molde que pueda ser impreso en impresora 3D con filamento Pla. 
 ...
 En este caso las piezas realizadas son po un lado la placa de texturas para utilizar con biomateriales en el próximo taller, logrando sacar una placa con medias esferas cóncavas y convexas. 

 La segunda Placa, es una media esfera con el que podríamos replicar un molde en caucho para poder realizar una esfera completa, es decir repetir la acción dos veces y unir ambas piezas, este molde es para trabajar con micelio debido a que el caucho es un material que puedo esterilizar.  
...
En este módulo pudimos aplicar el teórico de forma directa en un dibujo y luego materializarlo lo que vuelve más tangible la experiencia. 
